...
def _guarded_paper_note_close(state: dict, trade: dict) -> None:
    """Prevent the V16.4 stats layer from counting legacy-driven ECON closes.

    V16.6 finalizes ECON trades itself after validating the exact stored route;
    that path calls the original note-close function directly.
    """
